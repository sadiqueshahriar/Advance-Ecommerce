                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_name_en" required=""
                                                            class="form-control"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_name_hin" required=""
                                                            class="form-control"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_code" required=""
                                                            class="form-control" value="{{ $products->product_code }}">
                                                        @error('product_code')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_qty" required=""
                                                            class="form-control" value="{{ $products->product_qty }}">
                                                        @error('product_qty')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="selling_price" required=""
                                                            class="form-control" value="{{ $products->selling_price }}">
                                                        @error('selling_price')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
