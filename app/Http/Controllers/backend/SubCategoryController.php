...
class SubCategoryController extends Controller
{
    ...
    public function SubCategoryStore(Request $request){
       ...
       $notification=array(
        ...
        return redirect()->back()->with($notification);//end method
     ...
     public function SubCategoryUpdate(Request $request){
        ...
        return redirect()->route('all.subcategory')->with($nofification);//end method
   ...
   //////// //........sub->sub category...............//////////////////
    ...
    public function SubSubCategoryView(){
       $categories=Category::orderBy('category_name_en','ASC')->get();
        ...
        return view('backend.category.sub_sub_categoryview',compact('subsubcategories','categories'));
    }
